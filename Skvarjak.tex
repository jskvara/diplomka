...
\abstractCS{Cílem této diplomové práce byl návrh, implementace a otestování aplikace pro automatizaci ovládání  uživatelsých profilů na sociální síti Facebook. Po návrhu a implementaci byl pomocí této aplikace proveden experiment pro se zaměřením na přidávání nových přátel na facebooku. Pro experiment bylo založeno 25 facebookových účtů, které byly po dobu jednoho měsíce ovládány připravenou aplikací. Po ukončení experimentu byla všechna nasbíraná data zanalyzována a porovnána.}

\abstractEN{The main goal of this diploma thesis was ...}
