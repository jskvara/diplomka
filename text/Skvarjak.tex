...
\hyphenation{do-tyč-né-ho}
\hyphenation{o-pe-ra-ce}
\hyphenation{ús-pěš-né}
\hyphenation{o-me-ze-ně}
\hyphenation{fa-ce-boo-ko-vé-ho}
\hyphenation{strá-nku}
\hyphenation{a-pli-ka-ce}
\hyphenation{fa-ce-boo-ko-vých}
\hyphenation{ob-ráz-ku}
\hyphenation{po-měr-ně}
\hyphenation{poz-ván-ku}
\hyphenation{dal-ším}
\hyphenation{si-mu-lo-vat}
\hyphenation{ne-vý-ho-dou}
\hyphenation{na-hra-dil}
\hyphenation{na-ro-ze-ní}
\hyphenation{sprá-vě}
\hyphenation{o-me-ze-ně}
\hyphenation{dů-vě-ry-hod-nos-ti}
\hyphenation{pa-ra-met-rem}
\hyphenation{au-to-ma-ti-za-tion}
\hyphenation{au-to-ma-ti-za-ce}
...
\begin{figure}
	\dirtree{%
		...
		.1 sources\DTcomment{zdrojové kódy implementace a popis}.
		.2 readme.txt\DTcomment{návod pro zprovoznění a spuštění aplikace}.
		.2 www\DTcomment{zdrojové soubory aplikace}.
		.2 database\DTcomment{schéma pro vytvoření databázových tabulek}.
		.1 text\DTcomment{text práce}.
		.2 thesis.pdf\DTcomment{text práce ve formátu PDF}.
		.2 source\DTcomment{zdrojové soubory textu práce ve formátu \LaTeX{}}.
	}
\end{figure}
