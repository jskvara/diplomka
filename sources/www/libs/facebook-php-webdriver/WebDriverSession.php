...
final class WebDriverSession extends WebDriverContainer {
  ...
  // edited from: http://code.google.com/p/php-webdriver-bindings/issues/detail?id=17
  // example: $browser->timeouts('type'=>'implicit', 'ms'=>$timeout));
  // types: 'implicit', 'page load', 'script'
  ...
  // added from: http://code.google.com/p/php-webdriver-bindings/issues/detail?id=17
  public function wait($timeout) {
    $args = array(
      'type' => 'implicit',
      'ms' => $timeout
    );
    return $this->curl('POST', '/timeouts', $args);
  }
